...
const Map = forwardRef<MapRef, MapProps>(function Map(
  { children, className, theme: themeProp = "dark", styles, viewport, onViewportChange, loading = false, ...props },
  ref,
) {
...
function MarkerTooltip({ children, className, ...popupOptions }: MarkerTooltipProps) {
  ...
  return createPortal(
    <div className={cn("pointer-events-none rounded-md bg-[#161616] border border-[#c9a84c]/40 px-3 py-1.5 text-xs text-[#f0ebe0] font-sans shadow-xl animate-in fade-in-0 zoom-in-95 duration-200 ease-out", className)}>
      {children}
    </div>,
    container,
  );
